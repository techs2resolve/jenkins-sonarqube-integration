...
1. Configure Sonarqube credentials (as secret text)
1. Add Sonarqube to jenkins "configure system" by checking the box environment variable.
1. Install SonarScanner "Global Tool Configuration"
1. Run Pipeline job 
